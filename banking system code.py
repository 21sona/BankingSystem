...
def Cr_Amt(accnt,name):
	...
	creditwn.configure(bg="maroon")
	fr1=tk.Frame(creditwn,bg="blue")
	l_title=tk.Message(creditwn,text="PNB",relief="raised",width=1000,padx=600,pady=0,fg="maroon",bg="orange",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	l1=tk.Label(creditwn,relief="raised",text="Enter Amount to be credited: ",bg='orange',fg='black')
	e1=tk.Entry(creditwn,relief="raised")
	l1.place(x=100,y=100)
	e1.place(x=300,y=100)
	b=tk.Button(creditwn,text="Credit",relief="raised",bg='orange',fg='black',command=lambda:crdt_write(creditwn,e1.get(),accnt,name))
	b.place(x=250,y=150)
...
def De_Amt(accnt,name):
	...
	debitwn.configure(bg="maroon")
	fr1=tk.Frame(debitwn,bg="blue")
	l_title=tk.Message(debitwn,text="PNB",relief="raised",width=2000,padx=600,pady=0,fg="maroon",bg="orange",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	l1=tk.Label(debitwn,relief="raised",text="Enter Amount to be debited: ",bg='orange',fg='black')
	e1=tk.Entry(debitwn,relief="raised")
	l1.place(x=100,y=100)
	e1.place(x=300,y=100)
	b=tk.Button(debitwn,text="Debit",relief="raised",bg='orange',fg='black',command=lambda:debit_write(debitwn,e1.get(),accnt,name))
	b.place(x=250,y=150)
...
def disp_tr_hist(accnt):
	...
	disp_wn.configure(bg="maroon")
	fr1=tk.Frame(disp_wn,bg="blue")
	l_title=tk.Message(disp_wn,text="PNB",relief="raised",width=2000,padx=600,pady=0,fg="maroon",bg="orange",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	fr1=tk.Frame(disp_wn)
	fr1.pack(side="top")
	l1=tk.Message(disp_wn,text="Your Transaction History:",padx=100,pady=20,width=1000,bg="orange",fg="black",relief="raised")
	l1.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	rootwn.title("PUNJAB NATIONAL BANK" +name)
	rootwn.configure(bg="maroon")
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="WELCOME TO PNB SERVICES",relief="raised",width=2000,padx=600,pady=0,fg="maroon",bg="orange",justify="center",anchor="center" )
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	...
	loginwn.configure(bg="maroon")
	fr1=tk.Frame(loginwn,bg="maroon")
	l_title=tk.Message(loginwn,text="PNB",relief="sunken",width=2000,padx=600,pady=0,fg="maroon",bg="orange",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	l1=tk.Label(loginwn,text="Enter Name:",relief="raised",bg='orange',fg='black')
	l1.place(x=100,y=100)
	e1=tk.Entry(loginwn)
	e1.place(x=250,y=100)
	l2=tk.Label(loginwn,text="Enter account number:",relief="raised",bg='orange',fg='black')
	l2.place(x=100,y=150)
	e2=tk.Entry(loginwn)
	e2.place(x=250,y=150)
	l3=tk.Label(loginwn,text="Enter your PIN:",relief="raised",bg='orange',fg='black')
	l3.place(x=100,y=200)
	e3=tk.Entry(loginwn,show="*")
	e3.place(x=250,y=200)
	b=tk.Button(loginwn,text="Submit",bg='orange',fg='black',command=lambda: check_log_in(loginwn,e1.get().strip(),e2.get().strip(),e3.get().strip()))
	b.place(x=200,y=250)
...
def Create():
	...
	crwn.configure(bg="maroon")
	fr1=tk.Frame(crwn,bg="blue")
	l_title=tk.Message(crwn,text="PNB",relief="flat",width=2000,padx=600,pady=0,fg="maroon",bg="orange",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	l1=tk.Label(crwn,text="Enter Name:",relief="raised",bg='orange',fg='black')
	l1.place(x=100,y=100)
	e1=tk.Entry(crwn)
	e1.place(x=250,y=100)
	l2=tk.Label(crwn,text="Enter opening credit:",relief="raised",bg='orange',fg='black')
	l2.place(x=100,y=150)
	e2=tk.Entry(crwn)
	e2.place(x=250,y=150)
	l3=tk.Label(crwn,text="Enter desired PIN:",relief="raised",bg='orange',fg='black')
	l3.place(x=100,y=200)
	e3=tk.Entry(crwn,show="*")
	e3.place(x=250,y=200)
	b=tk.Button(crwn,text="Submit",bg='orange',fg='black',command=lambda: write(crwn,e1.get().strip(),e2.get().strip(),e3.get().strip()))
	b.place(x=200,y=250)
...
def Main_Menu():
	...
	rootwn.geometry("1600x500")
	rootwn.title("PNB")
	rootwn.configure(background='maroon')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	bg_image = tk.PhotoImage(file ="pile1.gif")
	x = tk.Label (image = bg_image)
	x.place(y=-400)
	l_title=tk.Message(text=" PUNJAB NATIONAL BANK",relief="raised",
            width=2000,padx=600,pady=0,fg="maroon",bg="orange",
